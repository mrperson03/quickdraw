...
document.getElementById('label_three').innerHTML = 'Sketch To be Drawn: ' + sketch;
...
function draw() {
  ...
  if(drawn_sketch == sketch)
  {
    answer_holder = "set"
    score++;
    document.getElementById('span_one').innerHTML = 'Score: ' + score;
  }
...
function gotResult(error, results) {
  ...
  document.getElementById('label_one').innerHTML = 'Your Sketch: ' + drawn_sketch;

  document.getElementById('label_two').innerHTML = 'Confidence: ' + Math.round(results[0].confidence * 100) + '%';
}
